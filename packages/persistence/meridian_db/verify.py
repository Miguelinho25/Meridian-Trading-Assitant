"""``python -m meridian_db.verify`` — audit chain integrity check.
...
from meridian_db.audit import chain_head, verify_chain
from meridian_db.session import dispose_engine, session_scope
