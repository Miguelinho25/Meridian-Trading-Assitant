...
import httpx
from nemonis_config.redaction import contains_secret, redact_text

from nemonis_router.registry import ModelSpec, Provider
    ...
    def _prepare(prompt: str) -> tuple[str, str]:
        ...
        if contains_secret(safe):
            raise RuntimeError(
                ...
                "defect in nemonis_config.redaction, not a transient failure."
            )
