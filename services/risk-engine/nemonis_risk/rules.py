...
from nemonis_marketdata.instruments import CORRELATION_CLUSTERS
from nemonis_schemas.enums import DataQualityVerdict, RejectionCode

from nemonis_risk.context import RiskContext
from nemonis_risk.decision import RuleOutcome
from nemonis_risk.limits import LimitSet
...
def rule_drawdown_block(ctx: RiskContext, _l: LimitSet, _s: Decimal) -> RuleOutcome:
    ...
    from nemonis_config import limits as system
